package ma.emsi.sadik.appresttemplate.services;
...
public class EtudiantClientService {
    ...
    private final String BASE_URL = "http://localhost:8090/eleves";
    private static final String BASE_URL2 = "http://localhost:8090/eleves/search/findEtudiantByNom?n={nom}";
